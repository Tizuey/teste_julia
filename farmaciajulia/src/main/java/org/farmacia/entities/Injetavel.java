...
public class Injetavel extends Remedio{
    ...
    public Injetavel(String nome_remedio, LocalDate data_vencimento, Float preco, int quantidade_estoque, Float concentracao, String modo_de_uso, String dosagem) {
